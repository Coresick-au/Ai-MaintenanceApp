...
export const SpeedSensorManager = () => {
    ...
    const { columnWidths, handleResizeStart, autoFitColumn } = useResizableColumns([120, 120, 120, 100, 80, 150, 150, 100, 120, 120, 100]);
                        ...
                        <div className="overflow-x-auto">
                            <table ref={tableRef} className="text-left text-sm" style={{ tableLayout: 'auto' }}>
                                <thead className="bg-slate-800 border-b border-slate-700">
                                    <tr>
                                        <SortableHeader field="materialType" index={0}>Material</SortableHeader>
                                        <SortableHeader field="design" index={1}>Design</SortableHeader>
                                        <SortableHeader field="rhsCutLength" index={2}>RHS Cut Length</SortableHeader>
                                        <SortableHeader field="beltWidth" index={3}>Belt Width</SortableHeader>
                                        <SortableHeader field="quantity" index={4}>Qty</SortableHeader>
                                        <th className="px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase relative" style={{ width: `${columnWidths[5]}px` }}>
                                        ...
                                        <th className="px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase relative" style={{ width: `${columnWidths[6]}px` }}>
                                        ...
                                        <SortableHeader field="costPrice" index={7}>Cost/Unit</SortableHeader>
                                        <SortableHeader field="totalCost" index={8}>Total Cost</SortableHeader>
                                        <SortableHeader field="effectiveDate" index={9}>Effective Date</SortableHeader>
                                        <th className="px-4 py-3 text-right text-xs font-medium text-slate-400 uppercase relative" style={{ width: `${columnWidths[10]}px` }}>
